...
export default function Home() {
    ...
    const createOrUpdateRemoteMediaElement = (
        ...
        if (!videoElement) {
            ...
            videoElement.muted = false; // Ensure not muted for audio
        ...
        console.log(`Added ${track.kind} track to stream for ${producerPeerId}`);

        // Ensure video plays with better error handling
        videoElement.play().then(() => {
            console.log(`Video element playing for ${producerPeerId}`);
        }).catch((error) => {
            console.error(`Error playing video for ${producerPeerId}:`, error);
